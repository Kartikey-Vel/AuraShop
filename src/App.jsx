...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-light via-surface-light to-white text-primary-dark dark:from-primary-dark dark:via-surface-dark dark:to-surface-dark dark:text-slate-100">
      <Navbar
        lang={lang}
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 pb-28">
        ...
        {/* Two-column layout: Shopping List (left), Suggestions (right) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
          ...
          {/* Suggestions and Status in right column */}
          <div className="flex flex-col gap-8">
            ...
            />
            {/* Status tab removed from here; will be floating at bottom right */}
          </div>
        </div>
      </main>
